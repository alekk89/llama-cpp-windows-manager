...
public static class HuggingFaceGridModeFactory
{
    ...
    public static void ConfigureDownloadHistory(HuggingFaceGridModeRequest request)
    {
        ...
        PageSectionFactory.AddButtonColumn(request.Grid, Loc.T("Common.DeleteButton"), nameof(HuggingFaceDownloadRow.DeleteAction), nameof(HuggingFaceDownloadRow.CanDelete), request.Actions.DeleteDownloadRow, .7, tooltipBinding: nameof(HuggingFaceDownloadRow.DeleteToolTip), visualRole: VisualRole.Danger, compactContent: "×");
        PageSectionFactory.ApplyGridTextMargin(request.Grid, new Thickness(6, 0, 6, 0));
