...
public sealed class ModelsPageActionController
{
    ...
    public ModelsPageActions Build()
        => new(
            ...
            _actions.ToggleModelFavoriteAsync,
            _actions.ToggleTrayProfileFavoriteAsync,
            _actions.ToggleStartupLaunchProfileAsync,
            _actions.LoadLaunchProfileAsync,
            _actions.CopyLaunchProfileToAnotherModelAsync,
