...
public partial class MainWindow
{
    ...
    private const string AppVersionLabel = "v2.5.0";
    ...
    private readonly DiagnosticProbeHistory _diagnosticProbeHistory = new();
    private TrayIconHost? _trayIcon;
    private TrayProfileMenuController? _trayProfileMenu;
