...
public partial class MainWindow
{
    private static void SetModelGridColumnSizing(DataGrid grid)
    {
        ...
        grid.Columns[1].Width = new DataGridLength(2.5, DataGridLengthUnitType.Star);
        grid.Columns[2].MinWidth = 72;
        grid.Columns[2].Width = new DataGridLength(.6, DataGridLengthUnitType.Star);
        grid.Columns[3].MinWidth = 98;
        grid.Columns[3].Width = new DataGridLength(118);
        grid.Columns[4].MinWidth = 86;
        grid.Columns[4].Width = new DataGridLength(.75, DataGridLengthUnitType.Star);
        grid.Columns[5].MinWidth = 72;
        grid.Columns[5].Width = new DataGridLength(86);
    }

    internal static void SetRuntimeGridColumnSizing(DataGrid grid)
    {
        if (grid.Columns.Count < 8) return;
        grid.Columns[0].MinWidth = 28;
        grid.Columns[0].MaxWidth = 28;
        grid.Columns[0].Width = new DataGridLength(28);
        grid.Columns[2].MinWidth = 120;
        grid.Columns[2].Width = new DataGridLength(2.1, DataGridLengthUnitType.Star);
        grid.Columns[3].MinWidth = 76;
        grid.Columns[3].Width = new DataGridLength(90);
        grid.Columns[4].MinWidth = 76;
        grid.Columns[4].Width = new DataGridLength(96);
        grid.Columns[5].MinWidth = 150;
        grid.Columns[5].Width = new DataGridLength(3.25, DataGridLengthUnitType.Star);
        grid.Columns[6].MinWidth = 72;
        grid.Columns[6].Width = new DataGridLength(78);
        grid.Columns[7].MinWidth = 72;
        grid.Columns[7].Width = new DataGridLength(86);
    }
