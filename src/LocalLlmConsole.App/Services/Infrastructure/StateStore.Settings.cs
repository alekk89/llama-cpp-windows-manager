...
public sealed partial class StateStore
{
    public async Task<AppSettings> GetAppSettingsAsync(string workspaceRoot)
    {
        ...
        var settings = defaults with
        {
            ...
            UiScalePercent = AppPreferenceService.NormalizeUiScalePercent(IntValue("uiScalePercent", defaults.UiScalePercent)),
            FontScalePercent = AppPreferenceService.NormalizeFontScalePercent(IntValue("fontScalePercent", defaults.FontScalePercent)),
            ...
            GatewayAutoLoadModels = BoolValue("gatewayAutoLoadModels", defaults.GatewayAutoLoadModels),
            DirectModelAliasSuffix = StringValue("directModelAliasSuffix", defaults.DirectModelAliasSuffix),
            SameModelLoadPolicy = AppPreferenceService.SameModelLoadPolicy(StringValue("sameModelLoadPolicy", defaults.SameModelLoadPolicy)),
            ...
            TensorBufferOverrides = StringValue("tensorBufferOverrides", defaults.TensorBufferOverrides),
            VulkanAllocationBlockSizeMiB = IntValue("vulkanAllocationBlockSizeMiB", defaults.VulkanAllocationBlockSizeMiB),
    ...
    public async Task SaveAppSettingsAsync(AppSettings settings)
    {
        ...
        var rows = new (string Key, object Value)[]
        {
            ...
            ("uiScalePercent", AppPreferenceService.NormalizeUiScalePercent(settings.UiScalePercent)),
            ("fontScalePercent", AppPreferenceService.NormalizeFontScalePercent(settings.FontScalePercent)),
            ...
            ("gatewayAutoLoadModels", settings.GatewayAutoLoadModels),
            ("directModelAliasSuffix", settings.DirectModelAliasSuffix),
            ("sameModelLoadPolicy", AppPreferenceService.SameModelLoadPolicy(settings.SameModelLoadPolicy)),
            ...
            ("vulkanAllocationBlockSizeMiB", settings.VulkanAllocationBlockSizeMiB),
