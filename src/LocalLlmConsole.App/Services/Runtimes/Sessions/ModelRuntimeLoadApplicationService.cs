...
public sealed class ModelRuntimeLoadApplicationService
{
        ...
        ModelRuntimeLoadApplicationActions actions)
    {
        ...
        await actions.RunBusyAsync(request.Restart
            ? Loc.T("Status.ModelRuntime.PreparingRestart")
            : Loc.T("Status.ModelRuntime.PreparingLoad"), async () =>
        {
        ...
        ModelRuntimeLoadApplicationActions actions)
    {
        ...
        var outcome = ModelRuntimeLoadApplicationOutcome.Status;
        await actions.RunBusyAsync(Loc.T("Status.ModelRuntime.PreparingLoad"), async () =>
        {
