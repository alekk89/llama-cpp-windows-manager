...
public sealed partial class ReleaseHardeningTests
{
    ...
    private static LoadedModelSessionSnapshot Session(
        ModelRecord model,
    ...
    private static ModelGroupSnapshot Snapshot(ModelGroupRecord group, params NamedModelLaunchProfile[] profiles)
        => new(
            [group],
