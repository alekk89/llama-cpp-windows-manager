...
public sealed class UsageMetricsTests : ManagerRegressionTestBase
{
    [Fact]
...
""";
    ...
    {
        var live = LocalLlmConsole.ControlCli.ControlCliRequestFactory.BuildForTests("metrics");
        var history = LocalLlmConsole.ControlCli.ControlCliRequestFactory.BuildForTests(
