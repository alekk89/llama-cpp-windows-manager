...
public sealed class ReleaseRepositoryTests : ManagerRegressionTestBase
{
    ...
    public void ProjectDeclaresVersionTwoThreeMetadata()
    {
        ...
        Assert.Contains("<Version>2.9.0</Version>", project, StringComparison.Ordinal);
        Assert.Contains("<AssemblyVersion>2.9.0.0</AssemblyVersion>", project, StringComparison.Ordinal);
        Assert.Contains("<FileVersion>2.9.0.0</FileVersion>", project, StringComparison.Ordinal);
        Assert.Contains("<InformationalVersion>v2.9.0</InformationalVersion>", project, StringComparison.Ordinal);
    }
