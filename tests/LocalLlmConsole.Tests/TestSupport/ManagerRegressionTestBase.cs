...
public abstract partial class ManagerRegressionTestBase
{
    ...
    protected static RuntimeLaunchRequest ValidLaunchRequest() => new()
    {
    ...
    protected static void WriteMinimalGguf(string path)
    {
    ...
    protected static void WriteGgufString(BinaryWriter writer, string value)
    {
    ...
    protected static string FindRepositoryFile(params string[] segments)
    {
    ...
    protected static string FindRepositoryRoot()
    {
        ...
        {
            if (File.Exists(Path.Combine(directory.FullName, "LocalLlmConsole.sln")))
                return directory.FullName;
            directory = directory.Parent;
        }

        throw new DirectoryNotFoundException("Could not locate the repository root containing LocalLlmConsole.sln.");
    }

    protected static string ReadMainWindowSources()
    {
    ...
    protected static string ReadApplicationResourceSources()
    {
    ...
    protected static string ReadLocalControlApiSources()
    {
    ...
    protected static string ReadAppServiceFactorySources()
    {
    ...
    protected static string ReadAppServiceFactoryFileNames()
    {
        var factoryPath = FindRepositoryFile("src", "LocalLlmConsole.App", "Services", "AppServiceFactory.cs");
        var servicesRoot = Path.GetDirectoryName(factoryPath)!;
        return string.Join(
    ...
    protected static string ReadLaunchSettingsPanelFactorySources()
    {
    ...
    protected static string ReadServicePartialSources(string prefix)
    {
    ...
    protected static void AssertServicePartials(string appRoot, string folder, string prefix, int maxLines, params string[] requiredFiles)
    {
