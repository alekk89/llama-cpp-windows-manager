...
public sealed class AppSettingsPersistenceContractTests : ManagerRegressionTestBase
{
    ...
    public async Task EveryPersistedAppSettingRoundTripsThroughSqlite()
    {
        ...
        var settings = AppSettings.CreateDefault(root) with
        {
            ...
            GatewayAutoLoadModels = false,
            DirectModelAliasSuffix = "-direct",
            SameModelLoadPolicy = "replace",
    ...
    [
        ...
        nameof(AppSettings.UiScalePercent),
        nameof(AppSettings.FontScalePercent),
        ...
        nameof(AppSettings.GatewayAutoLoadModels),
        nameof(AppSettings.DirectModelAliasSuffix),
        nameof(AppSettings.SameModelLoadPolicy),
        ...
        nameof(AppSettings.TensorBufferOverrides),
        nameof(AppSettings.VulkanAllocationBlockSizeMiB),
