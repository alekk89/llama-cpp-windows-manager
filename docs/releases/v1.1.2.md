...
Historical notes for the published v1.1.2 release. This file intentionally
preserves that release's terminology and behavior; it is not current user or
operator guidance. See the [v2.5.0 release draft](v2.5.0.md), the
[User guide](../USER_GUIDE.md), or the latest GitHub release for current behavior.
