...
$portableZip = Resolve-ReleaseFile (Join-Path $DistRoot "LlamaCppWindowsManager-$Runtime.zip") "Portable archive"
$portableHash = Resolve-ReleaseFile "$portableZip.sha256" "Portable archive checksum"
...
$artifacts = @(
  ...
  New-Artifact $portableZip "portable-archive" "application/zip"
  New-Artifact $portableHash "checksum" "text/plain"
